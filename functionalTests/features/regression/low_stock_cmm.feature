...
Feature: low stock
  ...
  And I make a new movement "01A01" "Issues" "PAV" "issued" "100"
  ...
  And I make a new movement "01A01" "Issues" "PAV" "issued" "123"
  Then I should see CMM ""
  ...
  Then I wait for "Stock Overview" to appear
  Then I wait for 1 second
  And I make a new movement "01A01" "Issues" "PAV" "issued" "210"
  Then I should see CMM ""
