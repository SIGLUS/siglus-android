...
public class Color implements java.io.Serializable {
   ...
   * If <code>null</code> after object construction, this must be an sRGB color constructed with
   * 8-bit precision, so compute from the
  ...
  /**
   * The alpha value as a <code>float</code> component. If <code>frgbvalue</code> is
   * <code>null</code>, this is not valid data, so compute from the <code>int</code> color value.
   *
   * @serial
   * @see #getRGBComponents
   * @see #getComponents
  ...
  /**
   * Checks the color <code>float</code> components supplied for validity. Throws an
   * <code>IllegalArgumentException</code> if the value is out of range.
   *
   * @param r the Red component
   * @param g the Green component
   * @param b the Blue component
   ...
   * component in bits 0-7. If the <code>hasalpha</code> argument is <code>false</code>, alpha is
   * defaulted to 255.
   *
  ...
  /**
   * Creates an sRGB color with the specified red, green, blue, and alpha values in the range (0.0 -
   * 1.0).  The actual color used in rendering depends on finding the best match given the color
  ...
  /**
   * Returns the RGB value representing the color in the default sRGB {@link ColorModel}. (Bits
   ...
   * <code>Color</code>. This method handles string formats that are used to represent octal and
   * hexadecimal numbers.
   *
   ...
   * <p>
   * The argument is treated as the name of a system property to be obtained. The string value of
   * this property is then interpreted as an integer which is then converted to a <code>Color</code>
   * object.
   * <p>
   ...
   * Finds a color in the system properties.
   * <p>
   * The first argument is treated as the name of a system property to be obtained. The string value
   * of this property is then interpreted as an integer which is then converted to a
   * <code>Color</code> object.
   * <p>
   * If the specified property is not found or cannot be parsed as an integer then the
   * <code>Color</code> specified by the second argument is returned instead.
   *
   * @param nm the name of the color property
   ...
   * <code>Color</code> object.
   * <p>
   * If the specified property is not found or could not be parsed as an integer then the integer
   * value <code>v</code> is used instead, and is converted to a <code>Color</code> object.
   *
   * @param nm the name of the color property
   ...
   * <p>
   * The <code>saturation</code> and <code>brightness</code> components should be floating-point
   ...
   * <p>
   * The integer that is returned by <code>HSBtoRGB</code> encodes the value of a color in bits 0-23
   * of an integer value that is the same format used by the method {@link #getRGB() getRGB}. This
   * integer can be supplied as an argument to the
   ...
   * <p>
   * If the <code>hsbvals</code> argument is <code>null</code>, then a new array is allocated to
   ...
   * <p>
   * The <code>s</code> and <code>b</code> components should be floating-point values between zero
   * and one (numbers in the range 0.0-1.0).  The <code>h</code> component can be any floating-point
   * number.  The floor of this number is subtracted from it to create a fraction between 0 and 1.
   * This fractional number is then multiplied by 360 to produce the hue angle in the HSB color
   * model.
   *
  ...
  /**
   * Returns a <code>float</code> array containing the color and alpha components of the
   * <code>Color</code>, as represented in the default sRGB color space. If <code>compArray</code>
   * is <code>null</code>, an array of length 4 is created for the return value.  Otherwise,
  ...
  /**
   * Returns a <code>float</code> array containing only the color components of the
   * <code>Color</code>, in the default sRGB color space.  If <code>compArray</code> is
   * <code>null</code>, an array of length 3 is created for the return value.  Otherwise,
  ...
  /**
   * Returns a <code>float</code> array containing the color and alpha components of the
   * <code>Color</code>, in the
   * <code>ColorSpace</code> of the <code>Color</code>.
   * If <code>compArray</code> is <code>null</code>, an array with length equal to the number of
   * components in the associated
   * <code>ColorSpace</code> plus one is created for
   * the return value.  Otherwise, <code>compArray</code> must have at least this length and it is
   * filled in with the components and returned.
   *
