...
public class StockCardAdapter implements JsonDeserializer<StockCard> {
  ...
  @Override
  public StockCard deserialize(JsonElement json, java.lang.reflect.Type typeOfT,
  ...
  private void updateStockCardIdIfStockCardAlreadyExist(StockCard stockCard) throws LMISException {
    StockCard stockCardInDB = stockRepository
        .queryStockCardByProductId(stockCard.getProduct().getId());
