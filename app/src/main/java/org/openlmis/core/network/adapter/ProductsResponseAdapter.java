...
public class ProductsResponseAdapter implements JsonDeserializer<SyncDownLatestProductsResponse> {
    ...
    public SyncDownLatestProductsResponse deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        final SyncDownLatestProductsResponse syncDownLatestProductsResponse = new SyncDownLatestProductsResponse();
        ...
        if (!responseObject.has("products")) return syncDownLatestProductsResponse;
    ...
    private ProductAndSupportedPrograms generateProductAndSupportedPrograms(JsonElement jsonElement) {
        ...
        final ProductAndSupportedPrograms productAndSupportedPrograms = new ProductAndSupportedPrograms();
        ...
        final List<ProductProgram> productPrograms = generateProductProgram(product, programCode, category);
    ...
    private List<ProductProgram> generateProductProgram(Product product, String programCode, String category) {
