...
public class FieldConstants {
  ...
  public static final String FOREIGN_DRAFT_LOTS = "foreignDraftLots";
  ...
  public static final String IS_MANUAL_ADD = "isManualAdd";
  ...
  public static final String MOVEMENT_QUANTITY = "movementQuantity";
