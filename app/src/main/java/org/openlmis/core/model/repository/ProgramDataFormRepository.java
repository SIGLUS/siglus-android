...
public class ProgramDataFormRepository {
    ...
    public void deleteOldData() {
        ...
        String rawSqlDeleteProgramDataItems = "DELETE FROM program_data_items "
                + "WHERE form_id IN (SELECT id FROM program_data_forms WHERE periodEnd < '" + dueDateShouldDataLivedInDB + "' );";
        ...
        LmisSqliteOpenHelper.getInstance(LMISApp.getContext()).getWritableDatabase().execSQL(rawSqlDeleteProgramDataItems);
        LmisSqliteOpenHelper.getInstance(LMISApp.getContext()).getWritableDatabase().execSQL(rawSqlDeleteProgramBasicItems);
        LmisSqliteOpenHelper.getInstance(LMISApp.getContext()).getWritableDatabase().execSQL(rawSqlDeleteSignatures);
        LmisSqliteOpenHelper.getInstance(LMISApp.getContext()).getWritableDatabase().execSQL(rawSqlDeleteProgramDataForms);
    }
}
