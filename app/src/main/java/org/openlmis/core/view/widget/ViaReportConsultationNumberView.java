...
public class ViaReportConsultationNumberView extends LinearLayout {
  ...
  public ViaReportConsultationNumberView(Context context, AttributeSet attrs) {
    ...
    TypedArray attributes = context
        .obtainStyledAttributes(attrs, R.styleable.ViaReportConsultationNumberView, 0,
  ...
  protected void onFinishInflate() {
    ...
    etExternalConsultationsPerformed
        .setFilters(new InputFilter[]{new InputFilterMinMax(Integer.MAX_VALUE)});
  ...
  public void addTextChangedListener() {
    etExternalConsultationsPerformed.post(() -> etExternalConsultationsPerformed
        .addTextChangedListener(etConsultationNumbersTextWatcher));
  }
