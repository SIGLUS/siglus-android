...
public class StockHistoryViewModel {
    ...
    public StockHistoryViewModel(StockCard stockCard) {
        ...
        allMovementItemViewModelList.addAll(FluentIterable.from(stockCard.getStockMovementItemsWrapper())
                .transform(stockMovementItem -> new StockHistoryMovementItemViewModel(stockMovementItem))
