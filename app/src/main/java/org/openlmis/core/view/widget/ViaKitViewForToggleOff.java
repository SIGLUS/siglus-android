...
public class ViaKitViewForToggleOff extends LinearLayout {
    ...
    public ViaKitViewForToggleOff(Context context) {
        super(context);
        init(context);
    }

    public ViaKitViewForToggleOff(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        LayoutInflater.from(context).inflate(R.layout.view_via_kit_toggle_off, this);
