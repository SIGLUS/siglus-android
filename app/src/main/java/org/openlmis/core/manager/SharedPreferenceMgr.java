...
public class SharedPreferenceMgr {
  ...
  public boolean isLastMonthStockDataSynced() {
    return sharedPreferences
        .getBoolean(SharedPreferenceMgr.KEY_HAS_SYNCED_LATEST_MONTH_STOCKMOVEMENTS,
            stockRepository.hasStockData());
  }

  public void setLastMonthStockCardDataSynced(boolean isStockCardSynced) {
    sharedPreferences.edit()
        .putBoolean(SharedPreferenceMgr.KEY_HAS_SYNCED_LATEST_MONTH_STOCKMOVEMENTS,
            isStockCardSynced).apply();
  }
  ...
  public void setShouldSyncLastYearStockCardData(boolean shouldSyncLastYearStockCardData) {
    sharedPreferences.edit()
        .putBoolean(SharedPreferenceMgr.KEY_SHOULD_SYNC_LAST_YEAR, shouldSyncLastYearStockCardData)
        .apply();
  }

  public boolean shouldInitialDataCheck() {
  ...
  public void setIsSyncingLastYearStockCards(boolean isSyncingLastYearStockCards) {
    sharedPreferences.edit()
        .putBoolean(SharedPreferenceMgr.KEY_IS_SYNCING_LAST_YEAR, isSyncingLastYearStockCards)
        .apply();
  }

  public boolean isRequisitionDataSynced() {
    RnrFormRepository rnrFormRepository = RoboGuice.getInjector(LMISApp.getContext())
  ...
  public boolean hasDeletedOldStockMovement() {
    return sharedPreferences
        .getBoolean(SharedPreferenceMgr.KEY_HAS_DELETED_OLD_STOCK_MOVEMENT, false);
  }
  ...
  public void setRequisitionDataSynced(boolean requisitionDataSynced) {
    sharedPreferences.edit()
        .putBoolean(SharedPreferenceMgr.KEY_IS_REQUISITION_DATA_SYNCED, requisitionDataSynced)
        .apply();
  }
  ...
  public void setReportTypesData(List<ReportTypeForm> reportTypeFormList) {
    ...
    sharedPreferences.edit().putString(SharedPreferenceMgr.LATEST_SYNCED_DOWN_REPORT_TYPE, json)
        .apply();
  }

  public List<ReportTypeForm> getReportTypesData() {
    String json = sharedPreferences
        .getString(SharedPreferenceMgr.LATEST_SYNCED_DOWN_REPORT_TYPE, null);
    if (json != null) {
      Gson gson = new GsonBuilder().setDateFormat(DateUtil.DATE_TIME_FORMAT).create();
  ...
  public void setIsNeedsInventory(boolean isNeedsInventory) {
    sharedPreferences.edit().putBoolean(SharedPreferenceMgr.KEY_NEEDS_INVENTORY, isNeedsInventory)
        .apply();
  }
  ...
  public void setIsNeedShowProductsUpdateBanner(boolean isNeedShowUpdateBanner,
      String primaryName) {
    sharedPreferences.edit().putBoolean(KEY_SHOW_PRODUCT_UPDATE_BANNER, isNeedShowUpdateBanner)
        .apply();
  ...
  public void setLatestPhysicInventoryTime(String latestPhysicInventoryTime) {
    sharedPreferences.edit().putString(LATEST_PHYSICAL_INVENTORY_TIME, latestPhysicInventoryTime)
        .apply();
  }
  ...
  public void setStockLastSyncTime() {
    sharedPreferences.edit()
        .putLong(KEY_LAST_SYNCED_TIME_STOCKCARD, LMISApp.getInstance().getCurrentTimeMillis())
        .apply();
  }
  ...
  public boolean hasSyncedUpLatestMovementLastDay() {
    DateTime lastSyncTriggerDate = new DateTime(
        sharedPreferences.getLong(LAST_MOVEMENT_HANDSHAKE_DATE, 0));
  ...
  public void setLastMovementHandShakeDateToToday() {
    sharedPreferences.edit()
        .putLong(LAST_MOVEMENT_HANDSHAKE_DATE, LMISApp.getInstance().getCurrentTimeMillis())
        .apply();
  }
  ...
  public void updateLatestMonthlyCheckDirtyDataTime() {
    sharedPreferences.edit()
        .putLong(LATEST_MONTHLY_CHECK_DIRTY_DATA_TIME, LMISApp.getInstance().getCurrentTimeMillis())
        .apply();
  }

  public void updateLatestLowStockAvgTime() {
    sharedPreferences.edit()
        .putLong(LATEST_UPDATE_LOW_STOCK_AVG_TIME, LMISApp.getInstance().getCurrentTimeMillis())
        .apply();
  }

  public void setHasDeletedOldStockMovement(boolean hasDeletedOldStockMovement) {
    sharedPreferences.edit().putBoolean(SharedPreferenceMgr.KEY_HAS_DELETED_OLD_STOCK_MOVEMENT,
        hasDeletedOldStockMovement).apply();
  }

  public void setHasDeletedOldRnr(boolean hasDeletedOldRnr) {
    sharedPreferences.edit()
        .putBoolean(SharedPreferenceMgr.KEY_HAS_DELETED_OLD_RNR, hasDeletedOldRnr).apply();
  }
  ...
  public void setRapidTestsDataSynced(boolean hasRapidTestsDataSynced) {
    sharedPreferences.edit()
        .putBoolean(SharedPreferenceMgr.KEY_HAS_SYNCED_DOWN_RAPID_TESTS, hasRapidTestsDataSynced)
        .apply();
  }

  public void setStockCardLastYearSyncError(boolean isSyncFailed) {
    sharedPreferences.edit()
        .putBoolean(SharedPreferenceMgr.KEY_STOCK_CARD_LAST_YEAR_SYNC_ERROR, isSyncFailed).apply();
  }

  public boolean isStockCardLastYearSyncError() {
    return sharedPreferences
        .getBoolean(SharedPreferenceMgr.KEY_STOCK_CARD_LAST_YEAR_SYNC_ERROR, false);
  }
