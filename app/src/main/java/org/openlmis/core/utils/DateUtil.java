...
public final class DateUtil {
  ...
  public static String formatDateWithShortMonthAndYear(Date date) {
    return new SimpleDateFormat(DATE_FORMAT_ONLY_MONTH_AND_YEAR_SHORT, Locale.getDefault())
        .format(date);
  }
  ...
  public static int calculateMonthOffset(DateTime biggerTime, DateTime smallerTime) {
    return biggerTime.getYear() * 12 + biggerTime.getMonthOfYear() - (smallerTime.getYear() * 12
        + smallerTime.getMonthOfYear());
  }
