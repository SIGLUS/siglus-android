    ...
    private class CheckUpdateTask extends AsyncTask<Void, Long, String[]> {
        ...
        protected void onProgressUpdate(Long... values) {
            ...
            if (isBetweenLollipopAndO()) {
                ...
                mNotificationBetweenLOLLIPOPAndroidOBuilder.setContentText(getString(R.string.upgrade_download_msg, progressAmount));
                notificationManager.notify(NOTIFICATION_ID, mNotificationBetweenLOLLIPOPAndroidOBuilder.build());
            } else if (isBetweenJellyBeanAndLollipop()) {
                mNotificationBetweenLOLLIPOPAndroidJELLY_BEANBuilder.setProgress(maxAmount, progressAmount, false);
                mNotificationBetweenLOLLIPOPAndroidJELLY_BEANBuilder.setContentText(getString(R.string.upgrade_download_msg, progressAmount));
                notificationManager.notify(NOTIFICATION_ID, mNotificationBetweenLOLLIPOPAndroidJELLY_BEANBuilder.build());
            } else if (isOAndHigher()) {
                mNotificationOAndHigherBuilder.setProgress(maxAmount, progressAmount, false);
                mNotificationOAndHigherBuilder.setContentText(getString(R.string.upgrade_download_msg, progressAmount));
