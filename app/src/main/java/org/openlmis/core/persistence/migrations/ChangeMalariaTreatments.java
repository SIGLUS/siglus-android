...
public class ChangeMalariaTreatments extends Migration {
    ...
    public void up() {
        ...
        execSQL("CREATE TABLE `malaria_program` ( `id` INTEGER PRIMARY KEY AUTOINCREMENT, `reportedDate` VARCHAR NOT NULL, `startPeriodDate` VARCHAR NOT NULL, `endPeriodDate` VARCHAR NOT NULL, `status` INTEGER NOT NULL, `username` VARCHAR NOT NULL, `createdAt` VARCHAR NOT NULL, `updatedAt` VARCHAR NOT NULL);");
