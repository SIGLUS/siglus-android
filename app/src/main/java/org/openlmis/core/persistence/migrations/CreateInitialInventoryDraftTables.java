...
public class CreateInitialInventoryDraftTables extends Migration {
  ...
  public void up() {
    ...
    execSQL(
        "CREATE UNIQUE INDEX `draft_initial_lot_items_idx` ON `draft_initial_lot_items` ( `id` )");
    ...
    execSQL(
        "CREATE UNIQUE INDEX `draft_initial_inventory_idx` ON `draft_initial_inventory` ( `id` );");
  }
}
