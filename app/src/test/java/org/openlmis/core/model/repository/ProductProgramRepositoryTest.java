...
public class ProductProgramRepositoryTest extends LMISRepositoryUnitTest {
  ...
  private final Product productOne = new ProductBuilder().setCode("P1").build();
  private final Product productSecond = new ProductBuilder().setCode("P2").build();
  ...
  public void shouldBatchSaveAndQueryProductPrograms() throws Exception {
    List<ProductProgram> product1Programs = Arrays.asList(
        new ProductProgramBuilder().setProgramCode("PR2").setProductCode("P1").setActive(true)
            .build()
    );
    List<ProductProgram> product2Programs = Arrays.asList(
        new ProductProgramBuilder().setProgramCode("PR1").setProductCode("P2").setActive(false)
            .build()
    );
  ...
  public void shouldNotCreateDuplicateProductProgram() throws Exception {
    List<ProductProgram> productPrograms = Arrays.asList(
        new ProductProgramBuilder().setProgramCode("PR1").setProductCode("P1").setActive(true)
            .build(),
        new ProductProgramBuilder().setProgramCode("PR1").setProductCode("P1").setActive(false)
            .build()
    );
  ...
  public void shouldListActiveProductProgramsByProgramCode() throws Exception {
    List<ProductProgram> productPrograms = Arrays.asList(
        new ProductProgramBuilder().setProgramCode("PR1").setProductCode("P1").setActive(true)
            .build(),
        new ProductProgramBuilder().setProgramCode("PR2").setProductCode("P1").setActive(false)
            .build()
    );
    repository.batchSave(productOne, productPrograms);

    List<ProductProgram> queriedProductPrograms = repository
        .listActiveProductProgramsByProgramCodes(Arrays.asList("PR1", "PR2"));
  ...
  public void shouldQueryActiveProductIdsByProgramsWithKits() throws Exception {
    ...
    when(productRepository.queryActiveProductsByCodesWithKits(anyList(), anyBoolean()))
        .thenReturn(newArrayList(
            new ProductBuilder().setCode("P1").setProductId(100L).build()
        ));

    List<Long> productIds = repository
        .queryActiveProductIdsByProgramsWithKits(newArrayList("PR1"), false);
  ...
  public void shouldCreateOrUpdateProductPrograms() throws Exception {
    List<ProductProgram> productOnePrograms = Arrays.asList(
        new ProductProgramBuilder().setProgramCode("PR1").setProductCode("P1").setCategory("Adult")
            .build(),
        new ProductProgramBuilder().setProgramCode("PR2").setProductCode("P1").setCategory("Adult")
            .build()
    );
    List<ProductProgram> productSecondPrograms = Arrays.asList(
        new ProductProgramBuilder().setProgramCode("PR1").setProductCode("P2")
            .setCategory("Children").build()
    );
    repository.batchSave(productOne, productOnePrograms);
    repository.batchSave(productSecond, productSecondPrograms);

    ProductProgram updateProductPrograms =
        new ProductProgramBuilder().setProgramCode("PR1").setProductCode("P1").setCategory("Other")
            .build();
