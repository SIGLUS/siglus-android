...
public class PeriodServiceTest {
    ...
    public void shouldGeneratePeriodWithPreviousRnrEndDateAsBeginAndNextMonthAsEndDate() throws Exception {
        ...
        when(mockRnrFormRepository.listWithoutEmergency(programMMIA.getProgramCode())).thenReturn(newArrayList(previousRnrForm));
    ...
    public void shouldReturnTrueIfRnrFromPreviousPeriodExistsButIsNotAuthorized() throws Exception {
        ...
        when(mockRnrFormRepository.listWithoutEmergency("P1")).thenReturn(newArrayList(rnRForm));
