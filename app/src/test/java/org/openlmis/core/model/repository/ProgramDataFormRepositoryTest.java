...
public class ProgramDataFormRepositoryTest extends LMISRepositoryUnitTest {
  ...
  public void shouldSaveProgramDataFormsAndListAllProgramDataForms() throws Exception {
    ...
    ProgramDataFormItem dataFormItem1 = new ProgramDataFormItem("name1",
        new ProgramDataColumnBuilder().setCode("POSITIVE_SYPHILLIS").build(), 1);
    ProgramDataFormItem dataFormItem2 = new ProgramDataFormItem("name2",
        new ProgramDataColumnBuilder().setCode("CONSUME_SYPHILLIS").build(), 9);
    ...
    List<ProgramDataForm> programDataFormRetrieved = programDataFormRepository
        .listByProgramCode("RapidTest");

    assertThat(programDataFormRetrieved.get(0).getPeriodBegin(),
    ...
    assertThat(programDataFormRetrieved.get(0).getProgramDataFormItemListWrapper().get(0).getName(),
        is("name1"));
    assertThat(programDataFormRetrieved.get(0).getProgramDataFormItemListWrapper().get(0)
        .getProgramDataColumn().getCode(), is("POSITIVE_SYPHILLIS"));
    assertThat(
        programDataFormRetrieved.get(0).getProgramDataFormItemListWrapper().get(0).getValue(),
        is(1));
    assertThat(programDataFormRetrieved.get(0).getProgramDataFormItemListWrapper().get(1).getName(),
        is("name2"));
    assertThat(programDataFormRetrieved.get(0).getProgramDataFormItemListWrapper().get(1)
        .getProgramDataColumn().getCode(), is("CONSUME_SYPHILLIS"));
    assertThat(
        programDataFormRetrieved.get(0).getProgramDataFormItemListWrapper().get(1).getValue(),
        is(9));
    assertThat(programDataFormRetrieved.get(0).getSignaturesWrapper().get(0).getSignature(),
        is("signature"));
    assertThat(programDataFormRetrieved.get(0).getSignaturesWrapper().get(0).getType(),
        is(Signature.TYPE.SUBMITTER));

    assertThat(programDataFormRetrieved.get(1).getPeriodBegin(),
        is(programDataForm2.getPeriodBegin()));
    assertThat(programDataFormRetrieved.get(1).getStatus(), is(programDataForm2.getStatus()));

    List<ProgramDataForm> programDataNonExist = programDataFormRepository
        .listByProgramCode("Some other program");
    ...
    ProgramDataFormItem dataFormItem3 = new ProgramDataFormItem("name3",
        new ProgramDataColumnBuilder().setCode("POSITIVE_MALARIA").build(), 100);
    ProgramDataFormItem dataFormItem4 = new ProgramDataFormItem("name4",
        new ProgramDataColumnBuilder().setCode("CONSUME_MALARIA").build(), 900);
    ...
    programDataFormRepository.batchCreateOrUpdate(programDataForm1);
    List<ProgramDataForm> programDataFormRetrievedAfterRevision = programDataFormRepository
        .listByProgramCode("RapidTest");
    ...
    assertThat(
        ...
        is(2));
    assertThat(
        programDataFormRetrievedAfterRevision.get(0).getProgramDataFormItemListWrapper().get(0)
            .getName(), is("name3"));
    assertThat(
        programDataFormRetrievedAfterRevision.get(0).getProgramDataFormItemListWrapper().get(0)
            .getProgramDataColumn().getCode(), is("POSITIVE_MALARIA"));
    assertThat(
        programDataFormRetrievedAfterRevision.get(0).getProgramDataFormItemListWrapper().get(0)
            .getValue(), is(100));
    assertThat(
        programDataFormRetrievedAfterRevision.get(0).getProgramDataFormItemListWrapper().get(1)
            .getName(), is("name4"));
    assertThat(
        programDataFormRetrievedAfterRevision.get(0).getProgramDataFormItemListWrapper().get(1)
            .getProgramDataColumn().getCode(), is("CONSUME_MALARIA"));
    assertThat(
        programDataFormRetrievedAfterRevision.get(0).getProgramDataFormItemListWrapper().get(1)
            .getValue(), is(900));
  }
  ...
  public void shouldListProgramDataItemsByFormId() throws Exception {
    ...
    ProgramDataFormItem dataFormItem1 = new ProgramDataFormItem("name1",
        new ProgramDataColumnBuilder().setCode("POSITIVE_HIVDETERMINE").build(), 1);
    ProgramDataFormItem dataFormItem2 = new ProgramDataFormItem("name2",
        new ProgramDataColumnBuilder().setCode("CONSUME_HIVDETERMINE").build(), 9);
    dataFormItem1.setForm(programDataForm1);
    dataFormItem2.setForm(programDataForm1);
    programDataForm1.getProgramDataFormItemListWrapper().add(dataFormItem1);
    programDataForm1.getProgramDataFormItemListWrapper().add(dataFormItem2);
    ...
    List<ProgramDataFormItem> programDataFormItemList = programDataFormRepository
        .listProgramDataItemsByFormId(programDataForm1.getId());

    assertEquals(2, programDataFormItemList.size());
    assertEquals("name1", programDataFormItemList.get(0).getName());
    assertEquals("POSITIVE_HIVDETERMINE",
        programDataFormItemList.get(0).getProgramDataColumn().getCode());
    assertEquals(1, programDataFormItemList.get(0).getValue());
    assertEquals("name2", programDataFormItemList.get(1).getName());
    assertEquals("CONSUME_HIVDETERMINE",
        programDataFormItemList.get(1).getProgramDataColumn().getCode());
  ...
  public void shouldDelete() throws Exception {
    ...
    assertEquals(0,
        programDataFormRepository.listProgramDataItemsByFormId(programDataForm1.getId()).size());
  }
}