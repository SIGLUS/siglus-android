...
public class StockCardTest {
  ...
  public void shouldInitStockMovementFromStockCard() throws Exception {
    ...
    assertThat(stockMovementItem.getMovementType(),
        is(MovementReasonManager.MovementType.PHYSICAL_INVENTORY));
  ...
  public void shouldGetNonEmptyLotOnHandList() throws Exception {
    Lot lot1 = new Lot();
    lot1.setExpirationDate(
        DateUtil.parseString("Sep 2014", DateUtil.DATE_FORMAT_ONLY_MONTH_AND_YEAR));
    LotOnHand lotOnHand1 = new LotOnHand();
    lotOnHand1.setLot(lot1);
    lotOnHand1.setQuantityOnHand(1L);
    Lot lot2 = new Lot();
    lot2.setExpirationDate(
        DateUtil.parseString("Jan 2013", DateUtil.DATE_FORMAT_ONLY_MONTH_AND_YEAR));
    LotOnHand lotOnHand2 = new LotOnHand();
    lotOnHand2.setLot(lot2);
    lotOnHand2.setQuantityOnHand(0L);
    Lot lot3 = new Lot();
    lot3.setExpirationDate(
        DateUtil.parseString("Feb 2014", DateUtil.DATE_FORMAT_ONLY_MONTH_AND_YEAR));
  ...
  public void shouldGetEarliestLotExpirationDate() throws Exception {
    ...
    stockCard.setLotOnHandListWrapper(Arrays.asList(lotOnHand1, lotOnHand2, lotOnHand3));
    assertThat(DateUtil
            .formatDate(stockCard.getEarliestLotExpiryDate(), DateUtil.DATE_FORMAT_ONLY_MONTH_AND_YEAR),
        is("Feb 2014"));
  }
