...
public class StockCardBuilder {
  ...
  public static StockCard saveStockCardWithOneMovement(StockRepository stockRepository,
      ProductRepository productRepository) throws LMISException, ParseException {
