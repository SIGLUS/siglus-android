...
public class StockServiceTest extends LMISRepositoryUnitTest {
  ...
  public void shouldCalculateAverageMonthlyConsumptionWithStockOutCorrectly() throws LMISException {
    ...
    createMovementItem(ISSUE, 100, stockCard, new Date(), lastForthMonthDate,
        false);//4 month ago soh:100

    createMovementItem(ISSUE, 100, stockCard, new Date(), lastThirdMonthDate,
        false);//3 month ago soh:0

    createMovementItem(RECEIVE, 400, stockCard, new Date(), lastSecondMonthDate,
        false);//2 month ago soh:400
    createMovementItem(ISSUE, 100, stockCard, new Date(), lastSecondMonthDate,
        false);//2 month ago soh:300

    createMovementItem(ISSUE, 100, stockCard, new Date(), lastFirstMonthDate,
        false);//1 month ago soh:200
  ...
  @Test
  public void shouldCalculateAverageMonthlyConsumptionWithContinuedStockOutCorrectly()
  ...
  @Test
  public void shouldCalculateAverageMonthlyConsumptionWithStockOutInTheMiddleOfPeriodCorrectly() throws LMISException {
    //given
    StockCard stockCard = new StockCard();
    stockCard.setProduct(getRandomProduct());
    ...
    createMovementItem(RECEIVE, 100, stockCard, new Date(), lastSecondMonthDate,
        false);//2 month ago soh:100
    createMovementItem(ISSUE, 100, stockCard, new Date(), lastSecondMonthDate,
        false);//2 month ago soh:0
    createMovementItem(RECEIVE, 200, stockCard, new Date(), lastSecondMonthDate,
        false);//2 month ago soh:200

    createMovementItem(ISSUE, 100, stockCard, new Date(), lastFirstMonthDate,
        false);//1 month ago soh:100
  ...
  @Test
  public void shouldCalculateAverageMonthlyConsumptionLessThanZeroWhenThereIsNoStockMovement()
      throws Exception {
    Product product = new Product();
    product.setId(1L);
