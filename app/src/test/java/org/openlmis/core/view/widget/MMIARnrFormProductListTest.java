...
public class MMIARnrFormProductListTest {
  ...
  public void shouldSortByProductCodeAndCategory() throws Exception {
    ...
    String text11 = ((TextView) ((LinearLayout) leftViewGroup.getChildAt(0)).getChildAt(0))
        .getText().toString();
    String text12 = ((TextView) ((LinearLayout) leftViewGroup.getChildAt(0)).getChildAt(1))
        .getText().toString();
    assertThat(text11, is(list.get(1).getProduct().getCode()));
    assertThat(text12, is(list.get(1).getProduct().getPrimaryName()));

    String text21 = ((TextView) ((LinearLayout) leftViewGroup.getChildAt(1)).getChildAt(0))
        .getText().toString();
    String text22 = ((TextView) ((LinearLayout) leftViewGroup.getChildAt(1)).getChildAt(1))
        .getText().toString();
    assertThat(text21, is(list.get(3).getProduct().getCode()));
    assertThat(text22, is(list.get(3).getProduct().getPrimaryName()));

    String text41 = ((TextView) ((LinearLayout) leftViewGroup.getChildAt(4)).getChildAt(0))
        .getText().toString();
    String text42 = ((TextView) ((LinearLayout) leftViewGroup.getChildAt(4)).getChildAt(1))
        .getText().toString();
    assertThat(text41, is(list.get(2).getProduct().getCode()));
    assertThat(text42, is(list.get(2).getProduct().getPrimaryName()));

    String text61 = ((TextView) ((LinearLayout) leftViewGroup.getChildAt(6)).getChildAt(0))
        .getText().toString();
    String text62 = ((TextView) ((LinearLayout) leftViewGroup.getChildAt(6)).getChildAt(1))
        .getText().toString();
  ...
  private String getCodeFromTextView(ViewGroup parentViewGroup, int first, int middle, int end) {
    return ((TextView) ((LinearLayout) ((LinearLayout) parentViewGroup.getChildAt(first))
        .getChildAt(middle)).getChildAt(end)).getText().toString();
  }

  private String getPrimaryNameTextView(ViewGroup parentViewGroup, int first, int middle, int end) {
    return ((TextView) (((LinearLayout) parentViewGroup.getChildAt(first)).getChildAt(middle)))
        .getText().toString();
  }
