...
public class BulkInitialInventoryActivityTest {
  ...
  public void shouldHaveFiveBasicAndFiveNoBasic() throws LMISException {
    ...
    Observable<List<InventoryViewModel>> observable = bulkInventoryActivity.presenter
        .loadInventory();
    observable.subscribe(subscriber);
    subscriber.awaitTerminalEvent();
    subscriber.assertNoErrors();

    bulkInventoryActivity.presenter.addNonBasicProductsToInventory(
        newArrayList(noBasicProducts.get(1), noBasicProducts.get(2), noBasicProducts.get(3),
            noBasicProducts.get(4), noBasicProducts.get(5)));
    List<InventoryViewModel> viewModels = bulkInventoryActivity.presenter
    ...
    assertEquals(viewModels.get(6).getViewType(),
