...
public class ArchivedDrugsViewHolderTest {
  ...
  public void setUp() {
    ...
    Product product = new ProductBuilder().setPrimaryName("Lamivudina 150mg").setCode("08S40")
        .setIsActive(true).setStrength("10mg").setType("VIA").build();
  ...
  public void shouldNotShowMoveBackToStockCardButtonIfProductIsInactive() {
    ...
    Product deactivatedProduct = new ProductBuilder().setPrimaryName("Lamivudina 300mg")
        .setCode("08S41").setIsActive(false).setStrength("10mg").setType("VIA").build();
