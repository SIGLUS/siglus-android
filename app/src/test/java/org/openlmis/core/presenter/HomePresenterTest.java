...
public class HomePresenterTest {
  ...
  public void setUp() throws Exception {
    ...
    Mockito.when(mockStockRepository.queryStockCountGroupByStockOnHandStatus())
        .thenReturn(stockOnHandStatusMap);
  }

  @Test
  public void getDashboardDataTest() {
    // given
    final TestSubscriber<Map<String, Integer>> testSubscriber = new TestSubscriber<>(
        presenter.queryStockCountObserver);
