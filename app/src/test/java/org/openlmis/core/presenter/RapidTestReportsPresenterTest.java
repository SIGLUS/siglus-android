...
public class RapidTestReportsPresenterTest {
    ...
    public void shouldGenerateViewModelsForAllPeriods() throws Exception {
        ...
        ProgramDataForm programDataForm3 = new ProgramDataFormBuilder()
                ...
                .build();
        when(programDataFormRepository.listByProgramCode(Constants.RAPID_TEST_CODE)).thenReturn(newArrayList(programDataForm1, programDataForm2, programDataForm3));
        ...
        assertNull(presenter.getViewModelList().get(2).getRapidTestForm());
