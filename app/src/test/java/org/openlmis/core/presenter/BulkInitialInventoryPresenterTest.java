...
public class BulkInitialInventoryPresenterTest extends LMISRepositoryUnitTest {
  ...
  public void shouldRestoreDraftInventoryWithDraftLotItems() throws Exception {
    ...
    Product product = ProductBuilder.create().setProductId(1L).setCode("basicCode").setIsBasic(true)
    ...
    LotMovementViewModel lotMovementViewModel1 = new LotMovementViewModelBuilder()
        .setLotNumber("test").setExpiryDate("Sep 2016").setQuantity("110").build();
    ...
    DraftInitialInventoryLotItem draftInitialInventoryLotItem1 = new DraftInitialInventoryLotItem(
        lotMovementViewModel1, product);
    DraftInitialInventoryLotItem draftInitialInventoryLotItem2 = new DraftInitialInventoryLotItem(
        lotMovementViewModel2, product);

    draftInitialInventory.setDraftLotItemListWrapper(
        newArrayList(draftInitialInventoryLotItem1, draftInitialInventoryLotItem2));
    ...
    assertThat(
        inventoryViewModels.get(0).getExistingLotMovementViewModelList().get(0).getLotNumber(),
        is("test"));
  ...
  public void shouldLoadBasicProductsList() throws LMISException {
    when(productRepositoryMock.listBasicProducts()).thenReturn(
        newArrayList(basicProducts.get(1L), basicProducts.get(2L), basicProducts.get(3L),
            basicProducts.get(4L), basicProducts.get(5L)));
  ...
  private ArrayList<InventoryViewModel> getStockCardViewModels() {
    ...
    InventoryViewModel inventoryViewModelWithOutDraft = buildInventoryViewModelWithOutDraft(3, "15",
        "11/02/2015");
  ...
  @NonNull
  private InventoryViewModel buildInventoryViewModelWithOutDraft(int stockCardId, String quantity,
      String expireDate) {
    InventoryViewModel inventoryViewModelWithOutDraft = new BulkInitialInventoryViewModel(
        buildDefaultStockCard());
  ...
  private void getBasicProductList() {
    Product product1 = ProductBuilder.create().setProductId(1L).setIsBasic(true).setCode("bABC")
        .setPrimaryName("bTest Product").build();
    Product product2 = ProductBuilder.create().setProductId(2L).setIsBasic(true)
        .setCode("bProductCode2").setPrimaryName("bProductName2").build();
    Product product3 = ProductBuilder.create().setProductId(3L).setIsBasic(true)
        .setCode("bProductCode3").setPrimaryName("bProductName3").build();
    Product product4 = ProductBuilder.create().setProductId(4L).setIsBasic(true)
        .setCode("bProductCode4").setPrimaryName("bProductName4").build();
    Product product5 = ProductBuilder.create().setProductId(5L).setIsBasic(true)
        .setCode("bProductCode5").setPrimaryName("bProductName5").build();
  ...
  private void getNoBasicProductList() {
    Product product1 = ProductBuilder.create().setProductId(1L).setIsBasic(false).setCode("ABC")
        .setPrimaryName("Test Product").build();
    Product product2 = ProductBuilder.create().setProductId(2L).setIsBasic(false)
        .setCode("productCode2").setPrimaryName("productName2").build();
    Product product3 = ProductBuilder.create().setProductId(3L).setIsBasic(false)
        .setCode("productCode3").setPrimaryName("productName3").build();
    Product product4 = ProductBuilder.create().setProductId(4L).setIsBasic(false)
        .setCode("productCode4").setPrimaryName("productName4").build();
    Product product5 = ProductBuilder.create().setProductId(5L).setIsBasic(false)
        .setCode("productCode5").setPrimaryName("productName5").build();
