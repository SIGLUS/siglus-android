...
LOCAL_DOCKER_SCRIPT="docker run --rm -v $(pwd):/openlmis-mobile --name test_local_debug -e JAVA_TOOL_OPTIONS=\"-Xmx4096m -XX:MaxPermSize=512m -Xms128m\" -e JAVA_OPTS=\"-XX:MaxPermSize=512m\" --memory 4096m -w /openlmis-mobile $taskrunner $gradleexec"
